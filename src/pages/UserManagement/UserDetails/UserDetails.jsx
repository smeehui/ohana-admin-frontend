...
import {Box, Button, CircularProgress, Container, Grid, Stack, TextField, useTheme,} from "@mui/material";
                                    ...
                                    <Stack
                                        ...
                                        <Stack>
                                            <TextField
                                                ...
                                                maxRows={4}
                                                readOnly={true}
                                                value={globalState.user.location
                                                    ? `${globalState.user.location.line1}, ${globalState.user.location.wardName}, ${globalState.user.location.districtName}, ${globalState.user.location.provinceName}.`
                                                    : null}
                                            />
                                        </Stack>
                            ...
                            >
                              ...
                              <CheckCircleOutlined sx={{ marginLeft: 1 }} />
                                ...
                                <Grid
                                    ...
                                    xs={4}
                                >
                                    {globalState.user.thumbnailId && !globalState.user.thumbnailId.match(
